...
$this->widget('bootstrap.widgets.TbTabs', array(
    ...
    'type' => 'tabs',
    'tabs' => array(
            array('id' => 'main', 'label' => Yii::t('app','Main'), 'content' => $this->renderPartial('edit/_main', array('form' => $form, 'model' => $model), true), 'active' => ($activeTab==NULL?true:false)),
	    ...
	    array('id' => 'conditions', 'label' => Yii::t('app','Conditions'), 'content' => $this->renderPartial('edit/_conditions', array('form' => $form, 'model' => $model) , true)),
            array('id' => 'actions', 'label' => Yii::t('app','Actions'), 'content' => $this->renderPartial('edit/_actions', array('form' => $form, 'model' => $model) , true), 'active' => ($activeTab=='actions'?true:false)),
