...
<?php $this->widget('bootstrap.widgets.TbNav', array(
    ...
    'items'=>array(
        ...
        array('label'=>Yii::t('translate','Hidden'), 'url'=>'index?type=hidden', 'active'=>Yii::app()->request->getParam('type','all') == 'hidden'),
        array('label'=>Yii::t('translate','Disabled'), 'url'=>'index?type=disabled', 'active'=>Yii::app()->request->getParam('type','all') == 'disabled'),
    ),
));
...
$this->widget('domotiyii.LiveGridView', array(
    ...
    'columns'=>array(
        ...
        array('name'=>'valuelabel', 'header'=>Yii::t('translate','Value'), 'htmlOptions'=>array('width'=>'40')),
        array('name'=>'valuelabel2', 'header'=>Yii::t('translate','Value2'), 'htmlOptions'=>array('width'=>'40')),
        array('name'=>'valuelabel3', 'header'=>Yii::t('translate','Value3'), 'htmlOptions'=>array('width'=>'40')),
        array('name'=>'valuelabel4', 'header'=>Yii::t('translate','Value4'), 'htmlOptions'=>array('width'=>'40')),
        array('name'=>'locationtext', 'header'=>Yii::t('translate','Location'), 'htmlOptions'=>array('width'=>'120')),
        array('name'=>'lastseentext', 'header'=>Yii::t('translate','Last Seen'), 'htmlOptions'=>array('width'=>'120')),
