...
$this->widget('domotiyii.LiveGridView', array(
    ...
    'columns'=>array(
        ...
        array('name'=>'enabled', 
            ...
            'value'=>'($data->enabled==-1?"<span class=\"label label-success\">On</span>":"<span class=\"label label-important\">Off</span>")',
            'type'=>'raw',
            'htmlOptions'=>array('width'=>'15')),
        array('name'=>'enabled', 
            'header'=>Yii::t('app','Hidden'), 
            'value'=>'($data->hide==-1?"<span class=\"label label-success\">On</span>":"<span class=\"label label-important\">Off</span>")',
            'type'=>'raw',
            'htmlOptions'=>array('width'=>'15')),
        ...
        array('name'=>'interface', 'header'=>Yii::t('app','Interfaces'),'value'=>'$data->l_interface->name', 'htmlOptions'=>array('width'=>'120')),
