...
<div class="row-fluid">
    ...
    <?php if($maxdate<$dev['lastchanged']) $maxdate=$dev['lastchanged']; ?>
        <div class="device text-left">
            ...
            <hr>
            <span class="slabel"><?php echo Yii::t('app', 'Value 1'); ?> : </span><div class="val1 label label-important"><?php echo $dev['val1']; ?></div>
            <br>
            <span class="slabel"><?php echo Yii::t('app', 'Last Seen'); ?> : </span><div class="lastchanged label label-info"><?php echo $dev['lastchanged']; ?></div>
            <div class="showAllVal"><span class="slabel"><?php echo Yii::t('app', 'Value 2'); ?> : </span><div class="val2 label label-important"><?php echo $dev['val2']; ?></div></div>
            <div class="showAllVal"><span class="slabel"><?php echo Yii::t('app', 'Value 3'); ?> : </span><div class="val3 label label-important"><?php echo $dev['val3']; ?></div></div>
            <div class="showAllVal"><span class="slabel"><?php echo Yii::t('app', 'Value 4'); ?> : </span><div class="val4 label label-important"><?php echo $dev['val4']; ?></div></div>
...
<script>
    ...
    function go() {
        formatDate();
        $('.newdata').removeClass('label-info').addClass('label-inverse');
        initSliders();
        needRefresh();
        $('.showValues').on('click', function() {
            if ($(this).hasClass('icon-chevron-down')) {
                ...
                $('.device').animate({height: '120px'}, 1000);
