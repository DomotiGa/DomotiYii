 ...
 *
 * The followings are the available columns in table 'settings_dmxplayer':
 * @property integer $id
 ...
 */
class SettingsDmxPlayer extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SettingsJeelabs the static model class
	 */
