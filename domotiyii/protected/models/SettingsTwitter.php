...
class SettingsTwitter extends CActiveRecord
{
	 ...
	 * @return SettingsTwitter the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, enabled, username, password, sendtimestamp, debug', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('sendtimestamp',$this->sendtimestamp);
