 ...
 *
 * The followings are the available columns in table 'settings_thermostat':
 * @property integer $id
 * @property boolean $enabled
 * @property integer $polltime
 * @property boolean $debug
 */
class SettingsThermostat extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SettingsThermostat the static model class
	 */
