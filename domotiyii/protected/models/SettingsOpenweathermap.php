 ...
 *
 * The followings are the available columns in table 'settings_openweathermap':
 * @property integer $id
 ...
 */
class SettingsOpenweathermap extends CActiveRecord
{
	/**
	 ...
	 * @return SettingsOpenweathermap the static model class
	 */
