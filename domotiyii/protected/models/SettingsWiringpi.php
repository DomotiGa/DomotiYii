 ...
 *
 * The followings are the available columns in table 'settings_wiringpi':
 * @property integer $id
 * @property boolean $enabled
 * @property integer $polltime
 * @property boolean $debug
 */
class SettingsWiringpi extends CActiveRecord
{
	/**
	 ...
	 * @return SettingsWiringpi the static model class
	 */
