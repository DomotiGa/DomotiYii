 ...
 *
 * The followings are the available columns in table 'settings_rflink':
 * @property integer $id
 ...
 */
class SettingsRflink extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SettingsRflink the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('tcphost, type', 'length', 'max'=>32),
			array('serialport', 'length', 'max'=>128),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, enabled, tcphost, tcpport, type, serialport, debug', 'safe', 'on'=>'search'),
		);
	}
