 ...
 *
 * The followings are the available columns in table 'settings_jerome':
 * @property integer $id
 ...
 */
class SettingsJerome extends CActiveRecord
{
	/**
	 ...
	 * @return SettingsJerome the static model class
	 */
