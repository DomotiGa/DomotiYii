 ...
 *
 * The followings are the available columns in table 'settings_viera':
 * @property integer $id
 ...
 */
class SettingsViera extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, enabled, tcphost, tcpport, refresh, debug', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return SettingsViera the static model class
	 */
