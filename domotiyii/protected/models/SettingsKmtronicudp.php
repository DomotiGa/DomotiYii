 ...
 *
 * The followings are the available columns in table 'settings_kmtronicudp':
 * @property integer $id
 ...
 */
class SettingsKmtronicudp extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SettingsKmtronicudp the static model class
	 */
