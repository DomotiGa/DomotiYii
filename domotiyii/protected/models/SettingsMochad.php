 ...
 *
 * The followings are the available columns in table 'settings_mochad':
 * @property integer $id
 ...
 */
class SettingsMochad extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('enabled, globalX10, debug', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, enabled, tcphost, tcpport, globalX10, debug', 'safe', 'on'=>'search'),
        );
    }
     ...
     * @return SettingsMochad the static model class
     */
