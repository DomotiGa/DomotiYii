 ...
 *
 * The followings are the available columns in table 'settings_genericio':
 * @property integer $id
 ...
 */
class SettingsGenericio extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, enabled, tcphost, tcpport, type, serialport, baudrate, debug, regex, delimiter', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return SettingsGenericio the static model class
	 */
