 ...
 *
 * The followings are the available columns in table 'settings_ipx800':
 * @property integer $id
 ...
 */
class SettingsIpx800 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, enabled, tcphost, tcpport, username, password, poll, debug', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return SettingsIpx800 the static model class
	 */
