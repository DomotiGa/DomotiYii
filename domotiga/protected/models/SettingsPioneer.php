 ...
 *
 * The followings are the available columns in table 'settings_pioneer':
 * @property integer $id
 ...
 */
class SettingsPioneer extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SettingsPioneer the static model class
	 */
