 ...
 *
 * The followings are the available columns in table 'settings_sharptv':
 * @property integer $id
 ...
 */
class SettingsSharptv extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return SettingsSharptv the static model class
	 */
