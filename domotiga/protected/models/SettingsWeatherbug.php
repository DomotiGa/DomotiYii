...
/**
 * This is the model class for table "settings_weatherbug".
 *
...
class SettingsWeatherbug extends CActiveRecord
{
	 ...
	 * @return SettingsWeatherbug the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, enabled, weatherbugid, city, citycode, countryname, debug', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('weatherbugid',$this->weatherbugid,true);
